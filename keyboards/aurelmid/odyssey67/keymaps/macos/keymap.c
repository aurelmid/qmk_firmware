...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT(
        ...
        KC_CAPS, KC_Q,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,       KC_J,    KC_K,    KC_L,    KC_M,    KC_QUOTE, KC_ENT,            KC_DEL,
        KC_LSFT, KC_W,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,       KC_COMM, KC_DOT,  KC_SCLN, KC_SLSH, KC_RSFT,           KC_UP,    KC_F4,
