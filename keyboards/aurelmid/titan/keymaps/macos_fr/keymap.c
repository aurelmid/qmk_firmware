...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    /* Base
     * ┌───┐ ┌───┬───┬───┬───┬───┬───┬───┬───┬───┬───┬───┬───┬───┬───────┬───┐ ┌───┬───┬───┬───┐
     * │Cut│ │ ~ │ 1 │ 2 │ 3 │ 4 │ 5 │ 6 │ 7 │ 8 │ 9 │ 0 │ - │ = │Bkspace│Esc│ │NUM│ / │ * │ - │
     * ├───┤ ├───┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─────┼───┤ ├───┼───┼───┼───┤
     * │Cpy│ │ Tab │ Q │ W │ E │ R │ T │ Y │ U │ I │ O │ P │ [ │ ] │  \  │LR1│ │ 7 │ 8 │ 9 │ + │
     * ├───┤ ├─────┴┬──┴┬──┴┬──┴┬──┴┬──┴┬──┴┬──┴┬──┴┬──┴┬──┴┬──┴┬──┴─────┼───┤ ├───┼───┼───┼───┤
     * │Pst│ │ Caps │ A │ S │ D │ F │ G │ H │ J │ K │ L │ ; │ ' │ Enter  │LR2│ │ 4 │ 5 │ 6 │ = │
     * ├───┤ ├──────┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴────┬───┼───┤ ├───┼───┼───┼───┤
     * │Und│ │ LShift │ Z │ X │ C │ V │ B │ N │ M │ , │ . │ / │RShift│ ↑ │Del│ │ 1 │ 2 │ 3 │ E │
     * ├───┤ ├────┬───┴┬──┴─┬─┴───┴───┴───┴───┴───┴──┬┴──┬┴──┬┴──┬───┼───┼───┤ ├───┼───┼───┤ N │
     * │Mve│ │LCtl│LOpt│LCmd│         Space          │RCd│ROp│Fqt│ ← │ ↓ │ → │ │ 0 │ . │   │ T │
     * └───┘ └────┴────┴────┴────────────────────────┴───┴───┴───┴───┴───┴───┘ └───┴───┴───┴───┘
     */
    [0] = LAYOUT(
        LCMD(KC_X),   KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS,     KC_EQL,  KC_BSPC, KC_ESC,       KC_NUM,  KC_PSLS, KC_PAST, KC_PMNS,
        LCMD(KC_C),   KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC,     KC_RBRC, KC_BSLS, MO(1),        KC_P7,   KC_P8,   KC_P9,   KC_PPLS,
        LCMD(KC_V),   KC_CAPS, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,     KC_ENT,           MO(2),        KC_P4,   KC_P5,   KC_P6,   KC_PEQL,
        LCMD(KC_Z),   KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,              KC_UP,   KC_DEL,       KC_P1,   KC_P2,   KC_P3,   KC_PENT,
        LAG(KC_V),    KC_LCTL, KC_LOPT, KC_LCMD,                   KC_SPC,                             KC_RCMD, KC_ROPT, LAG(KC_ESC), KC_LEFT, KC_DOWN, KC_RGHT,      KC_P0,   KC_PDOT, _______
    ),
